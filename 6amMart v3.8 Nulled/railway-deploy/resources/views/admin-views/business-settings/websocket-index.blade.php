...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="fs-12 px-3 py-2 rounded bg-info bg-opacity-10 mb-20">
            ...
            <a target="_blank" href="https://Nexo Food.app/documentation/admin-application-configuration/3rd-party-setup/" class="theme-clr fs-12 text-underline">{{ translate('messages.Get Credential Setup') }}</a>
        </div>
