...
<script>
    ...
    function initMap() {
        var lat = {{ $default_location ? $default_location['lat'] : '38.7223' }};
        var lng = {{ $default_location ? $default_location['lng'] : '-9.1393' }};

        map = L.map('location_map_canvas').setView([lat, lng], 13);
