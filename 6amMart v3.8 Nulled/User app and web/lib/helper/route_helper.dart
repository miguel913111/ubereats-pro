...
import 'package:nexofood_user/common/widgets/zone_warning_dialog.dart';
import 'package:nexofood_user/features/auth/controllers/auth_controller.dart';
import 'package:nexofood_user/features/auth/screens/new_user_setup_screen.dart';
import 'package:nexofood_user/features/auth/screens/rider_registration_screen.dart';
import 'package:nexofood_user/features/brands/screens/brands_product_screen.dart';
import 'package:nexofood_user/features/brands/screens/brands_screen.dart';
import 'package:nexofood_user/features/business/screens/subscription_payment_screen.dart';
import 'package:nexofood_user/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:nexofood_user/features/chat/domain/models/order_chat_model.dart';
import 'package:nexofood_user/features/checkout/screens/digital_payment_failed_screen.dart';
import 'package:nexofood_user/features/home/screens/home_screen.dart';
import 'package:nexofood_user/features/item/screens/item_view_all_screen.dart';
import 'package:nexofood_user/features/language/controllers/language_controller.dart';
import 'package:nexofood_user/features/loyalty/screens/loyalty_screen.dart';
import 'package:nexofood_user/features/profile/domain/models/update_user_model.dart';
import 'package:nexofood_user/features/profile/screens/setting_page.dart';
import 'package:nexofood_user/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:nexofood_user/features/splash/controllers/splash_controller.dart';
import 'package:nexofood_user/features/notification/domain/models/notification_body_model.dart';
import 'package:nexofood_user/features/address/domain/models/address_model.dart';
import 'package:nexofood_user/features/item/domain/models/basic_campaign_model.dart';
import 'package:nexofood_user/features/chat/domain/models/conversation_model.dart';
...
import 'package:nexofood_user/features/address/screens/add_address_screen.dart';
import 'package:nexofood_user/features/address/screens/address_screen.dart';
import 'package:nexofood_user/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:nexofood_user/features/auth/screens/sign_in_screen.dart';
import 'package:nexofood_user/features/auth/screens/sign_up_screen.dart';
import 'package:nexofood_user/features/auth/screens/store_registration_screen.dart';
import 'package:nexofood_user/features/category/screens/category_screen.dart';
import 'package:nexofood_user/features/location/screens/map_screen.dart';
import 'package:nexofood_user/features/store/screens/campaign_screen.dart';
import 'package:nexofood_user/features/store/widgets/all_store_web_view_widget.dart';
import 'package:nexofood_user/helper/address_helper.dart';
import 'package:nexofood_user/helper/auth_helper.dart';
import 'package:nexofood_user/helper/module_helper.dart';
import 'package:nexofood_user/api/api_client.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:nexofood_user/helper/shallow_route_helper.dart';
import 'package:nexofood_user/util/app_constants.dart';
import 'package:nexofood_user/util/html_type.dart';
import 'package:nexofood_user/common/widgets/custom_loader.dart';
import 'package:nexofood_user/common/widgets/image_viewer_screen.dart';
import 'package:nexofood_user/common/widgets/not_found.dart';
import 'package:nexofood_user/features/cart/screens/cart_screen.dart';
import 'package:nexofood_user/features/category/screens/category_item_screen.dart';
import 'package:nexofood_user/features/chat/screens/chat_screen.dart';
import 'package:nexofood_user/features/chat/screens/conversation_screen.dart';
import 'package:nexofood_user/features/checkout/screens/checkout_screen.dart';
import 'package:nexofood_user/features/payment/screens/offline_payment_screen.dart';
...
import 'package:nexofood_user/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:nexofood_user/features/item/screens/item_campaign_screen.dart';
import 'package:nexofood_user/features/item/screens/item_details_screen.dart';
import 'package:nexofood_user/features/item/screens/popular_item_screen.dart';
import 'package:nexofood_user/features/verification/screens/forget_pass_screen.dart';
import 'package:nexofood_user/features/verification/screens/new_pass_screen.dart';
import 'package:nexofood_user/features/verification/screens/verification_screen.dart';
import 'package:nexofood_user/features/html/screens/html_viewer_screen.dart';
import 'package:nexofood_user/features/interest/screens/interest_screen.dart';
import 'package:nexofood_user/features/language/screens/language_screen.dart';
import 'package:nexofood_user/features/location/screens/access_location_screen.dart';
import 'package:nexofood_user/features/location/screens/pick_map_screen.dart';
import 'package:nexofood_user/features/notification/screens/notification_screen.dart';
import 'package:nexofood_user/features/onboard/screens/onboarding_screen.dart';
import 'package:nexofood_user/features/order/screens/guest_track_order_screen.dart';
import 'package:nexofood_user/features/order/screens/order_details_screen.dart';
import 'package:nexofood_user/features/order/screens/order_screen.dart';
import 'package:nexofood_user/features/order/screens/order_tracking_screen.dart';
import 'package:nexofood_user/features/order/screens/refund_request_screen.dart';
import 'package:nexofood_user/features/parcel/screens/parcel_category_screen.dart';
import 'package:nexofood_user/features/parcel/screens/parcel_location_screen.dart';
import 'package:nexofood_user/features/parcel/screens/parcel_request_screen.dart';
import 'package:nexofood_user/features/profile/screens/profile_screen.dart';
import 'package:nexofood_user/features/profile/screens/update_profile_screen.dart';
import 'package:nexofood_user/features/store/screens/all_store_screen.dart';
import 'package:nexofood_user/features/store/screens/store_item_search_screen.dart';
import 'package:nexofood_user/features/store/screens/store_screen.dart';
import 'package:nexofood_user/features/review/screens/review_screen.dart';
import 'package:nexofood_user/features/search/screens/search_screen.dart';
import 'package:nexofood_user/features/splash/screens/splash_screen.dart';
import 'package:nexofood_user/features/support/screens/support_screen.dart';
import 'package:nexofood_user/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:nexofood_user/features/wallet/screens/wallet_screen.dart';
import 'package:nexofood_user/features/ride_share_module/safety_alert/screens/safety_policy_screen.dart';
import 'package:nexofood_user/features/story/screens/story_view_screen.dart';
import 'package:nexofood_user/features/dine_in/screens/dine_in_screen.dart';
import 'package:nexofood_user/features/dine_in/screens/qr_code_screen.dart';
import 'package:nexofood_user/features/document_verification/screens/document_verification_screen.dart';
import 'package:nexofood_user/features/gift_card/screens/gift_card_screen.dart';
...
class RouteHelper {
  ...
  static const String dineInQr = '/dine-in-qr';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: giftCard, page: () => const GiftCardScreen()),
    GetPage(name: documentVerification, page: () => const DocumentVerificationScreen()),
    GetPage(name: dineIn, page: () => const DineInScreen()),
    GetPage(name: dineInQr, page: () => QrCodeScreen(reservationId: int.parse(Get.parameters['id']!))),
    GetPage(name: stories, page: () => const StoryViewScreen()),
  ...
  static Widget _waitForModule(String? moduleId, Widget child, {bool fromDeeplink = false}) {
    if(moduleId != null && moduleId.isNotEmpty && moduleId != 'null') {
      ...
      return _ModuleFutureBuilder(key: ValueKey(moduleId), moduleId: moduleId, child: child, fromDeeplink: fromDeeplink);
    } else {
      return child;
    }
  }
...
class _ModuleFutureBuilder extends StatefulWidget {
  final String moduleId;
  final Widget child;
  final bool fromDeeplink;

  const _ModuleFutureBuilder({super.key, required this.moduleId, required this.child, this.fromDeeplink = false});

  @override
  State<_ModuleFutureBuilder> createState() => _ModuleFutureBuilderState();
}

class _ModuleFutureBuilderState extends State<_ModuleFutureBuilder> {
  late final Future<void> _future;

  @override
  void initState() {
    super.initState();
    _future = RouteHelper.checkModuleId(widget.moduleId, fromDeeplink: widget.fromDeeplink);
  }
