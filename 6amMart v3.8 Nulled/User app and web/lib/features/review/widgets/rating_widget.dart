...
import 'package:nexofood_user/features/review/widgets/rating_progress_widget.dart';
import 'package:nexofood_user/features/review/widgets/total_rating_review_view_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ResponsiveHelper.isDesktop(context) ? Column(children: [
        ...
        RatingBar(rating: averageRating, ratingCount: ratingCount, size: 20),
