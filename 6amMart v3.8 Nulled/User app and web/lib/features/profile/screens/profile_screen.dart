import 'package:nexofood_user/features/profile/widgets/notification_status_change_bottom_sheet.dart';
...
import 'package:nexofood_user/features/profile/widgets/profile_button_widget.dart';
import 'package:nexofood_user/features/profile/widgets/profile_card_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:nexofood_user/features/profile/widgets/web_profile_widget.dart';
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                isLoggedIn ? ProfileButtonWidget(icon: Icons.card_giftcard, title: 'gift_cards'.tr, onTap: () {
                  Get.toNamed(RouteHelper.giftCard);
                }) : const SizedBox(),
                SizedBox(height: isLoggedIn ? Dimensions.paddingSizeSmall : 0),

                isLoggedIn ? ProfileButtonWidget(icon: Icons.verified_user, title: 'document_verification'.tr, onTap: () {
                  Get.toNamed(RouteHelper.documentVerification);
                }) : const SizedBox(),
                SizedBox(height: isLoggedIn ? Dimensions.paddingSizeSmall : 0),

                isLoggedIn ? ProfileButtonWidget(icon: Icons.restaurant, title: 'dine_in'.tr, onTap: () {
