...
import 'package:nexofood_user/features/location/widgets/dynamic_text_color.dart';
...
import 'package:nexofood_user/features/location/widgets/web_landing_page_shimmer_widget.dart';
...
import 'package:nexofood_user/features/location/widgets/landing_card_widget.dart';
import 'package:nexofood_user/features/location/widgets/registration_card_widget.dart';
...
class _WebLandingPageState extends State<WebLandingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    int length = Get.find<SplashController>().landingModel != null ? Get.find<SplashController>().landingModel!.specialCriterias!.length : 0;
      ...
      child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: GetBuilder<SplashController>(
        builder: (splashController) {
          return splashController.landingModel == null ? const WebLandingPageShimmerWidget() : Column(children: [
            ...
            //
            length <= 4 ?  Row(spacing: Dimensions.paddingSizeDefault, children: _generateChooseUsList(splashController, length)) : SizedBox(
              height: 200,
              child: ListView(
                padding: EdgeInsets.all(10),
                scrollDirection: Axis.horizontal,
                shrinkWrap: true,
                children: _generateChooseUsList(splashController, length),
              ),
            ),
  ...
  List<Widget> _generateChooseUsList(SplashController splashController, int length) {
    List<Widget> chooseUsList = [];
    for(int index=0; index < length; index++) {
      if(length <= 4){
        chooseUsList.add(Expanded(child: Expanded(child: LandingCardWidget(
        ...
        chooseUsList.add(SizedBox(
          width: 300,
          child: Padding(
            padding: EdgeInsets.only(right: index == length-1 ?  0 : Dimensions.paddingSizeDefault),
