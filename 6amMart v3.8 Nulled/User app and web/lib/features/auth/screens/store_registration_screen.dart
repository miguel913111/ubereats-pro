...
import 'package:nexofood_user/common/widgets/confirmation_dialog.dart';
import 'package:nexofood_user/common/widgets/custom_asset_image_widget.dart';
import 'package:nexofood_user/features/auth/widgets/business/base_card_widget.dart';
import 'package:nexofood_user/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:nexofood_user/features/auth/widgets/module_view_widget.dart';
import 'package:nexofood_user/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:nexofood_user/features/business/widgets/package_card_widget.dart';
...
import 'package:nexofood_user/common/models/translation.dart';
...
import 'package:nexofood_user/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:nexofood_user/features/auth/widgets/pass_view_widget.dart';
import 'package:nexofood_user/features/auth/widgets/select_location_view_widget.dart';
import 'package:nexofood_user/helper/responsive_helper.dart';
import 'package:nexofood_user/helper/validate_check.dart';
...
import 'package:nexofood_user/common/widgets/custom_text_field.dart';
import 'package:nexofood_user/common/widgets/footer_view.dart';
import 'package:nexofood_user/common/widgets/menu_drawer.dart';
import 'package:nexofood_user/common/widgets/web_page_title_widget.dart';
      ...
      child: Scaffold(
        ...
        body: SafeArea(child: GetBuilder<StoreRegistrationController>(builder: (storeRegController) {
          ...
          return isDesktop ? webView(storeRegController, isDesktop) : Column(children: [
            ...
            storeRegController.storeStatus == 0.9 ? SizedBox() : Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                            ...
                            Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                storeRegController.tinFiles!.isEmpty ? InkWell(
                                  ...
                                  options: RoundedRectDottedBorderOptions(radius: const Radius.circular(Dimensions.radiusDefault), dashPattern: const [8, 4], strokeWidth: 1, color: const Color(0xFFE5E5E5),),
