...
class Item {
  ...
  Item.fromJson(Map<String, dynamic> json) {
    ...
    // Fallback: if single image is null but images array has values, use the first one
    if ((imageFullUrl == null || imageFullUrl!.isEmpty) && imagesFullUrl != null && imagesFullUrl!.isNotEmpty) {
      imageFullUrl = imagesFullUrl![0];
    }
