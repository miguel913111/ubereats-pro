...
import 'package:nexofood_user/api/api_checker.dart';
import 'package:nexofood_user/features/cart/controllers/cart_controller.dart';
import 'package:nexofood_user/features/checkout/domain/models/payment_model.dart';
import 'package:nexofood_user/features/checkout/domain/models/surge_price_model.dart';
...
import 'package:nexofood_user/features/checkout/domain/models/timeslote_model.dart';
import 'package:nexofood_user/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:nexofood_user/features/checkout/widgets/order_successfull_dialog.dart';
import 'package:nexofood_user/features/checkout/widgets/partial_pay_dialog_widget.dart';
...
class CheckoutController extends GetxController implements GetxService {
  ...
  Future<void> insertAddresses(AddressModel? addressModel, {bool notify = false}) async {
    ...
    try {
      ...
      contactPersonNumberController.text = phoneNumber.international.substring(countryDialCode!.length);
    } catch (e) {
