...
import 'package:nexofood_user/features/home/widgets/web/web_recomanded_store_view_widget.dart';
...
class WebFlashSaleViewWidget extends StatefulWidget {
  const WebFlashSaleViewWidget({super.key, required this.showBanner});
    ...
    return GetBuilder<FlashSaleController>(builder: (flashSaleController) {
      ...
      return flashSaleController.flashSaleModel != null ? flashSaleController.flashSaleModel!.activeProducts != null ? Container(
        ...
        child: Column(children: [
          ...
          Container(
            width: !widget.showBanner ? 280 : Get.width,
          ...
          flashSaleController.flashSaleModel!.activeProducts != null ? SizedBox(
            width: !widget.showBanner ? 300 : Get.width,
            child: FlashSaleCard(
