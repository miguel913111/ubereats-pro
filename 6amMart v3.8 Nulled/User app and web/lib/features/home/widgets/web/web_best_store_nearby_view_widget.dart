...
import 'package:nexofood_user/features/home/widgets/web/widgets/arrow_icon_button.dart';
...
import 'package:nexofood_user/common/widgets/card_design/store_card.dart';
            ...
            isPharmacy ? Padding(
              ...
              child: FittedBox(
                child: Row(children: [
                  ...
                  InkWell(
                    onTap: () => Get.toNamed(RouteHelper.getAllStoreRoute('best_store', isNearbyStore: true)),
                    child: Padding(
                                  ...
                                  return OnHover(
                                    ...
                                    child: isPharmacy ? StoreCard(store: storeList[index]) : InkWell(
                                      ...
                                      onTap: () {
                                        ...
                                        Get.toNamed(
                                          RouteHelper.getStoreRoute(id: storeList[index].id, page: 'store', slug: storeList[index].slug??''),
