...
import 'package:nexofood_user/features/home/widgets/popular_store_view.dart';
        ...
        if(AuthHelper.isLoggedIn() && locationController.addressList != null) {
          ...
          if(userAddress?.id != null) {
            for(int index=0; index<locationController.addressList!.length; index++) {
              if(locationController.addressList![index].id == userAddress!.id) {
                contain = true;
                break;
              }
            }
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: AddressWidget(
                      ...
                      onTap: () {
                        final userAddress = AddressHelper.getUserAddressFromSharedPref();
                        if(userAddress?.id != addressList[index]!.id) {
