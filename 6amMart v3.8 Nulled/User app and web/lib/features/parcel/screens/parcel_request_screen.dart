...
import 'package:nexofood_user/features/checkout/widgets/guest_create_account.dart';
import 'package:nexofood_user/features/parcel/widgets/from_to_address_card.dart';
import 'package:nexofood_user/features/parcel/widgets/parcel_payment_method_bottom_sheet.dart';
...
import 'package:nexofood_user/helper/price_converter.dart';
import 'package:nexofood_user/helper/responsive_helper.dart';
import 'package:nexofood_user/helper/string_extension.dart';
...
import 'package:nexofood_user/common/widgets/custom_image.dart';
...
import 'package:nexofood_user/common/widgets/not_logged_in_screen.dart';
import 'package:nexofood_user/features/checkout/widgets/condition_check_box.dart';
import 'package:nexofood_user/features/checkout/widgets/tips_widget.dart';
import 'package:nexofood_user/features/parcel/widgets/card_widget.dart';
import 'package:nexofood_user/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
import 'package:nexofood_user/features/parcel/widgets/details_widget.dart';
              ...
              return Column(children: [
                ...
                Expanded(child: SingleChildScrollView(
                  ...
                  child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    CardWidget(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('who_will_pay'.tr, style: robotoMedium),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                    ...
                    CardWidget(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('billing_summary'.tr, style: robotoMedium),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
  ...
  Widget _bottomButton(ParcelController parcelController, double charge, {bool isGuestLoggedIn = false}) {
    ...
    return Container(
      decoration: ResponsiveHelper.isDesktop(context) ? null : BoxDecoration(
        color: Theme.of(context).cardColor,
        boxShadow: [BoxShadow(color: Colors.grey[Get.isDarkMode ? 800 : 200]!, blurRadius: 10)],
      ),
