...
import 'package:nexofood_user/features/notification/domain/models/notification_model.dart';
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                notificationModel.imageFullUrl != null && notificationModel.imageFullUrl!.isNotEmpty ? ClipRRect(
                  ...
                  child: CustomAssetImageWidget(
                    notificationModel.data!.type == 'push_notification' ? Images.pushNotificationIcon
                        : notificationModel.data!.type == 'order_status' ? Images.orderConfirmIcon : Images.referEarnIcon,
                    height: 100, width: 100, fit: BoxFit.cover,
                  ),
                ),
                SizedBox(height: notificationModel.imageFullUrl != null && notificationModel.imageFullUrl!.isNotEmpty ? Dimensions.paddingSizeDefault : Dimensions.paddingSizeExtraOverLarge),
