...
import 'package:nexofood_user/features/home/widgets/web/widgets/store_card_widget.dart';
...
import 'package:nexofood_user/common/widgets/item_shimmer.dart';
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ? GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          mainAxisExtent: ResponsiveHelper.isDesktop(context) && widget.isStore ? 220 : ResponsiveHelper.isMobile(context) ? widget.isStore ? 200 : 110 : widget.isStore ? 200 : 110,
