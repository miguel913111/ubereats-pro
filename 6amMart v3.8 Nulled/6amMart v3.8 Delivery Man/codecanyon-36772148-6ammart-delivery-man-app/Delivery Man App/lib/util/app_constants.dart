...
class AppConstants {
  ...
  /// Delivery Batches
  static const String myBatchUri = '/api/v1/delivery-man/my-batch';
  static const String batchDetailsUri = '/api/v1/delivery-man/batch/details';
  static const String startBatchUri = '/api/v1/delivery-man/batch/start';
  static const String deliverOrderUri = '/api/v1/delivery-man/batch/deliver-order';
  static const String updateSequenceUri = '/api/v1/delivery-man/batch/update-sequence';
  static const String rejectBatchUri = '/api/v1/delivery-man/batch/reject';
  static const String acceptBatchUri = '/api/v1/delivery-man/batch/accept';
  static const String completeDeliveryUri = '/api/v1/delivery-man/batch/complete-delivery';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.portuguese, languageName: 'Português', countryCode: 'PT', languageCode: 'pt'),
  ];
