            ...
            <div class="">
                <div class="">
                    <form action="{{route('admin.users.custom-role.update',[$role['id']])}}" method="post">
                        ...
                        <div class="pt-5">
                            <h4>{{translate('Custom Features Management')}}</h4>
                        </div>
                        <div class="check--item-wrapper">
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="dine_in" class="form-check-input"
                                           id="dine_in" {{in_array('dine_in',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="dine_in">{{translate('messages.dine_in')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="delivery_optimization" class="form-check-input"
                                           id="delivery_optimization" {{in_array('delivery_optimization',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="delivery_optimization">{{translate('messages.delivery_optimization')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="hybrid_pricing" class="form-check-input"
                                           id="hybrid_pricing" {{in_array('hybrid_pricing',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="hybrid_pricing">{{translate('messages.hybrid_pricing')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="story" class="form-check-input"
                                           id="story" {{in_array('story',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="story">{{translate('messages.story')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="store_delivery_zone" class="form-check-input"
                                           id="store_delivery_zone" {{in_array('store_delivery_zone',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="store_delivery_zone">{{translate('messages.store_delivery_zone')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="gift_card" class="form-check-input"
                                           id="gift_card" {{in_array('gift_card',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="gift_card">{{translate('messages.gift_card')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="modules[]" value="document_verification" class="form-check-input"
                                           id="document_verification" {{in_array('document_verification',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label ps--3 qcont text-dark opacity-70" for="document_verification">{{translate('messages.document_verification')}}</label>
                                </div>
                            </div>
                        </div>
