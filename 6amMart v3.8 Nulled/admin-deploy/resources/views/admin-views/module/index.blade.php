                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn action-btn btn--danger btn-outline-danger form-alert" href="javascript:"
                                           data-id="delete-{{$module['id']}}" data-message="{{translate('Want_to_delete_this')}} <strong>{{translate('Business_Module?')}}</strong>">
                                            <i class="tio-delete-outlined"></i>
                                        </a>
                                        <form action="{{route('admin.business-settings.module.delete',[$module['id']])}}" method="post" id="delete-{{$module['id']}}">
                                            @csrf @method('delete')
                                        </form>
                                    </div>
                                </td>
