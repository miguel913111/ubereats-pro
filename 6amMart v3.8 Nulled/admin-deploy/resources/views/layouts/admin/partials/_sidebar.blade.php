    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                @if (\App\CentralLogics\Helpers::module_permission_check('hybrid_pricing'))
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/hybrid-pricing*') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.hybrid-pricing.index') }}" title="{{ translate('messages.Hybrid Pricing') }}">
                        <span class="tio-money nav-icon"></span>
                        <span class="text-truncate">{{ translate('messages.Hybrid Pricing') }}</span>
                    </a>
                </li>
                @endif
                @if (\App\CentralLogics\Helpers::module_permission_check('delivery_optimization'))
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-optimization*') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.delivery-optimization.index') }}" title="{{ translate('messages.Delivery Optimization') }}">
                        <span class="tio-route nav-icon"></span>
                        <span class="text-truncate">{{ translate('messages.Delivery Optimization') }}</span>
                    </a>
                </li>
                @endif
                @if (\App\CentralLogics\Helpers::module_permission_check('dine_in'))
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/dine-in*') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.dine-in.tables') }}" title="{{ translate('messages.Dine In') }}">
                        <span class="tio-restaurant nav-icon"></span>
                        <span class="text-truncate">{{ translate('messages.Dine In') }}</span>
                    </a>
                </li>
                @endif
                @if (\App\CentralLogics\Helpers::module_permission_check('story'))
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/story*') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.story.index') }}" title="{{ translate('messages.Stories') }}">
                        <span class="tio-photo-gallery nav-icon"></span>
