...
import 'package:nexofood_vendor/common/widgets/custom_bottom_sheet_widget.dart';
...
import 'package:nexofood_vendor/features/profile/widgets/notification_status_change_bottom_sheet.dart';
...
import 'package:nexofood_vendor/common/widgets/switch_button_widget.dart';
import 'package:nexofood_vendor/features/profile/widgets/profile_bg_widget.dart';
import 'package:nexofood_vendor/features/profile/widgets/profile_card_widget.dart';
        ...
        return profileController.profileModel == null ? const Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          mainWidget: SingleChildScrollView(child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              _isOwner ? SwitchButtonWidget(icon: Icons.verified_user, title: 'document_verification'.tr, onTap: () {
                Get.toNamed(RouteHelper.documentVerification);
              }) : const SizedBox(),
              SizedBox(height: _isOwner ? Dimensions.paddingSizeSmall : 0),

              _isOwner ? SwitchButtonWidget(icon: Icons.map, title: 'delivery_zones'.tr, onTap: () {
                Get.toNamed(RouteHelper.storeDeliveryZone);
              }) : const SizedBox(),
              SizedBox(height: _isOwner ? Dimensions.paddingSizeSmall : 0),

              _isOwner ? SwitchButtonWidget(icon: Icons.delivery_dining, title: 'self_delivery'.tr, onTap: () {
                Get.toNamed(RouteHelper.selfDelivery);
              }) : const SizedBox(),
              SizedBox(height: _isOwner ? Dimensions.paddingSizeSmall : 0),

              _isOwner ? SwitchButtonWidget(icon: Icons.restaurant, title: 'dine_in'.tr, onTap: () {
                Get.toNamed(RouteHelper.dineIn);
              }) : const SizedBox(),
              SizedBox(height: _isOwner ? Dimensions.paddingSizeSmall : 0),

              _isOwner ? SwitchButtonWidget(icon: Icons.camera_alt, title: 'stories'.tr, onTap: () {
                Get.toNamed(RouteHelper.stories);
              }) : const SizedBox(),
              SizedBox(height: _isOwner ? Dimensions.paddingSizeSmall : 0),

              _isOwner ? SwitchButtonWidget(icon: Icons.monetization_on, title: 'hybrid_pricing'.tr, onTap: () {
                Get.toNamed(RouteHelper.hybridPricing);
              }) : const SizedBox(),
              SizedBox(height: _isOwner ? Dimensions.paddingSizeSmall : 0),
