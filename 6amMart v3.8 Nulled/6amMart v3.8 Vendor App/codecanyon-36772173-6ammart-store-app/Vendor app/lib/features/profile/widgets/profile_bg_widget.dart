...
class ProfileBgWidget extends StatelessWidget {
  ...
  const ProfileBgWidget({super.key, required this.mainWidget, required this.circularImage, required this.backButton, this.menuButton});
    ...
    return Column(children: [
      ...
      Stack(clipBehavior: Clip.none, children: [
        ...
        Positioned(
          ...
          child: Text(
            'edit_profile'.tr, textAlign: TextAlign.center,
