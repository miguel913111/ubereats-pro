...
import 'package:nexofood_vendor/common/models/vat_tax_model.dart';
...
import 'package:nexofood_vendor/features/ai/domain/models/attribute_data_model.dart';
import 'package:nexofood_vendor/features/ai/domain/models/other_data_model.dart';
import 'package:nexofood_vendor/features/ai/domain/models/variation_data_model.dart';
...
import 'package:nexofood_vendor/features/store/domain/models/attr.dart';
import 'package:nexofood_vendor/features/store/domain/models/band_model.dart';
import 'package:nexofood_vendor/features/store/domain/models/suitable_tag_model.dart';
...
import 'package:nexofood_vendor/features/store/domain/models/pending_item_model.dart';
...
import 'package:nexofood_vendor/features/store/domain/models/unit_model.dart';
...
class StoreController extends GetxController implements GetxService {
  ...
  Future<void> addItem(Item item, bool isAdd, {String? genericNameData}) async {
    ...
    Response response = await storeServiceInterface.addItem(item, _pickedMetaImage, _rawLogo, _rawImages, _savedImages, fields, isAdd, tags, nutrition, allergicIngredients, genericName);
