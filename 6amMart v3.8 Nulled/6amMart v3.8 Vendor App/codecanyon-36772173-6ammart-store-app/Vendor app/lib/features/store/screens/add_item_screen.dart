...
import 'package:nexofood_vendor/common/widgets/custom_asset_image_widget.dart';
import 'package:nexofood_vendor/common/widgets/custom_drop_down_button.dart.dart';
import 'package:nexofood_vendor/common/widgets/custom_dropdown_widget.dart';
import 'package:nexofood_vendor/common/widgets/custom_ink_well_widget.dart';
import 'package:nexofood_vendor/common/widgets/custom_text_field_widget.dart';
import 'package:nexofood_vendor/common/widgets/custom_tool_tip_widget.dart';
import 'package:nexofood_vendor/common/widgets/label_widget.dart';
...
import 'package:nexofood_vendor/features/ai/widgets/ai_generator_bottom_sheet.dart';
import 'package:nexofood_vendor/features/ai/widgets/animated_border_container.dart';
...
import 'package:nexofood_vendor/features/store/domain/models/variant_type_model.dart';
import 'package:nexofood_vendor/features/store/domain/models/variation_body_model.dart';
import 'package:nexofood_vendor/features/store/domain/models/attribute_model.dart';
import 'package:nexofood_vendor/common/models/config_model.dart';
import 'package:nexofood_vendor/features/store/domain/models/item_model.dart';
import 'package:nexofood_vendor/helper/type_converter.dart';
...
import 'package:nexofood_vendor/common/widgets/custom_time_picker_widget.dart';
import 'package:nexofood_vendor/features/store/widgets/attribute_view_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:nexofood_vendor/features/store/widgets/food_variation_view_widget.dart';
  ...
  void initState() {
    ...
    if(isEcommerce && _update) {
      ...
      if (widget.item?.metaData != null) {
        _maxSnippetController.text = widget.item!.metaData!.metaMaxSnippetValue?.toString() ?? '';
        _maxVideoPreviewController.text = widget.item!.metaData!.metaMaxVideoPreviewValue?.toString() ?? '';
      }
    }
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    AnimatedBorderContainer(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        categoryController.selectedSubCategoryID != null && categoryController.subCategoryList != null && categoryController.subCategoryList!.isNotEmpty ? CustomDropdownButton(
                        ...
                        SizedBox(height: categoryController.selectedSubCategoryID != null && categoryController.subCategoryList != null && categoryController.subCategoryList!.isNotEmpty ? Dimensions.paddingSizeExtraLarge : 0),
                              ...
                              child: DottedBorder(
                                ...
                                child: Container(
                                  ...
                                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    ...
                                    const SizedBox(height: Dimensions.paddingSizeDefault),
                                      Text( 'click_to_upload'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                      Text('image_format'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor), textAlign: TextAlign.center),
                                  ]),
                                ),
                              ),
                            );
                                ...
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: storeController.pickedMetaImage != null ?
                                      GetPlatform.isWeb ?
                                        Image.network(storeController.pickedMetaImage!.path, width: double.infinity, height: 150, fit: BoxFit.cover)
                  ...
                  child: CustomButtonWidget(
                    ...
                    onPressed: () {
                      ...
                      if(defaultDataNull) {
                        ...
                        showCustomSnackBar('enter_discount_type'.tr);
                      ...
                      }else if(isEcommerce && metaTitle.isEmpty){
                      ...
                      }else if(!_update && storeController.rawLogo == null && _item.imageFullUrl == null) {
