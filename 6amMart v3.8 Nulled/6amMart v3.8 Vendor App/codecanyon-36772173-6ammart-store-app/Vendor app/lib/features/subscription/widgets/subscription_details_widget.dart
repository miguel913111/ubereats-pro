...
import 'package:nexofood_vendor/features/subscription/widgets/billing_info_widget.dart';
import 'package:nexofood_vendor/features/subscription/widgets/change_subscription_plan_bottom_sheet.dart';
import 'package:nexofood_vendor/features/subscription/widgets/subscription_dialog_widget.dart';
          ...
          child: Padding(
            ...
            child: businessIsCommission ? Column(children: [
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '${widget.subscriptionController.profileModel!.stores![0].comission} %',
                        ...
                        Text(
                          ...
                          style: robotoMedium.copyWith(color: Colors.blueGrey[700], fontSize: Dimensions.fontSizeLarge),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Text(
                    "${'vendor_will_pay'.tr} ${widget.subscriptionController.profileModel!.stores![0].comission}% ${'commission_to'.tr} ${Get.find<SplashController>().configModel!.businessName} ${'from_each_order_You_will_get_access_of_all'.tr}",
                    style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7), height: 2), textAlign: TextAlign.start,
                  )
                    ...
                    child: Center(
                      child: Wrap(alignment: WrapAlignment.end, crossAxisAlignment: WrapCrossAlignment.end, children: [
                        ...
                        Padding(
                          ...
                          child: Text(' ${widget.subscriptionController.profileModel!.subscription!.package!.validity} ${'days'.tr}', style: robotoMedium),
                        ),
                      ]),
                    ),
                  ),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('billing_details'.tr, style: robotoBold),
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Divider(height: Dimensions.paddingSizeExtraOverLarge,),
