...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'gift-card', 'as' => 'gift-card.'], function () {
        Route::get('list', 'GiftCardController@index')->name('list');
        Route::post('store', 'GiftCardController@store')->name('store');
        Route::post('update/{id}', 'GiftCardController@update')->name('update');
        Route::delete('delete/{id}', 'GiftCardController@destroy')->name('delete');
        Route::get('status/{id}/{status}', 'GiftCardController@status')->name('status');
    });

    // Document Verification
    Route::group(['prefix' => 'document-verification', 'as' => 'document-verification.'], function () {
        Route::get('list', 'DocumentVerificationController@index')->name('list');
        Route::get('view/{id}', 'DocumentVerificationController@show')->name('view');
        Route::post('approve/{id}', 'DocumentVerificationController@approve')->name('approve');
        Route::post('reject/{id}', 'DocumentVerificationController@reject')->name('reject');
    });

    // Dine-in
    Route::group(['prefix' => 'dine-in', 'as' => 'dine-in.'], function () {
        Route::get('tables', 'DineInController@tables')->name('tables');
        Route::get('reservations', 'DineInController@reservations')->name('reservations');
        Route::get('confirm-reservation/{id}', 'DineInController@confirmReservation')->name('confirm');
        Route::get('complete-reservation/{id}', 'DineInController@completeReservation')->name('complete');
        Route::post('cancel-reservation/{id}', 'DineInController@cancelReservation')->name('cancel');
    });

    // Stories
    Route::group(['prefix' => 'story', 'as' => 'story.'], function () {
        Route::get('index', 'StoryController@index')->name('index');
        Route::get('status/{id}/{status}', 'StoryController@status')->name('status');
        Route::delete('delete/{id}', 'StoryController@destroy')->name('delete');
    });

    // Store Delivery Zones
    Route::group(['prefix' => 'store-delivery-zone', 'as' => 'store-delivery-zone.'], function () {
        Route::get('list', 'StoreDeliveryZoneController@index')->name('list');
        Route::post('status', 'StoreDeliveryZoneController@status')->name('status');
        Route::delete('delete/{id}', 'StoreDeliveryZoneController@destroy')->name('delete');
    });

    // Hybrid Pricing
    Route::group(['prefix' => 'hybrid-pricing', 'as' => 'hybrid-pricing.'], function () {
        Route::get('index', 'HybridPricingController@index')->name('index');
        Route::post('update-store-models/{id}', 'HybridPricingController@updateStoreModels')->name('update-store-models');
        Route::post('update-driver-rates/{id}', 'HybridPricingController@updateDriverRates')->name('update-driver-rates');
        Route::get('rider-fares', 'HybridPricingController@riderFares')->name('rider-fares');
        Route::post('update-rider-fare/{id}', 'HybridPricingController@updateRiderFare')->name('update-rider-fare');
        Route::get('global-settings', 'HybridPricingController@globalSettings')->name('global-settings');
        Route::post('update-global-settings', 'HybridPricingController@updateGlobalSettings')->name('update-global-settings');
    });

    // Delivery Optimization
    Route::group(['prefix' => 'delivery-optimization', 'as' => 'delivery-optimization.'], function () {
        Route::get('index', 'DeliveryOptimizationController@index')->name('index');
        Route::post('auto-batch', 'DeliveryOptimizationController@autoBatch')->name('auto-batch');
        Route::get('show/{id}', 'DeliveryOptimizationController@show')->name('show');
        Route::get('settings', 'DeliveryOptimizationController@settings')->name('settings');
        Route::post('update-settings', 'DeliveryOptimizationController@updateSettings')->name('update-settings');
        Route::get('time-windows', 'DeliveryOptimizationController@timeWindows')->name('time-windows');
        Route::post('time-windows/store', 'DeliveryOptimizationController@storeTimeWindow')->name('time-windows.store');
        Route::delete('time-windows/delete/{id}', 'DeliveryOptimizationController@deleteTimeWindow')->name('time-windows.delete');
    });
});
