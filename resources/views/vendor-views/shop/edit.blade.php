                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-12">
                                    ...
                                    <hr class="my-3">
                                    <h6 class="mb-2">{{translate('messages.location_on_map')}}</h6>
                                    <div class="form-group">
                                        <label for="latitude">{{translate('messages.latitude')}}</label>
                                        <input type="text" name="latitude" id="latitude" value="{{$shop->latitude}}" class="form-control" placeholder="Ex: 38.7223">
                                    </div>
                                    <div class="form-group">
                                        <label for="longitude">{{translate('messages.longitude')}}</label>
                                        <input type="text" name="longitude" id="longitude" value="{{$shop->longitude}}" class="form-control" placeholder="Ex: -9.1393">
                                    </div>
                                    <div class="form-group">
                                        <label>{{translate('messages.click_map_to_set_location')}}</label>
                                        <div id="vendor-map" style="height: 250px; width: 100%; border-radius: 8px; border: 1px solid #ddd;"></div>
                                    </div>
                                </div>
...
@push('script_2')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var lat = parseFloat(document.getElementById('latitude').value) || 38.7223;
            var lng = parseFloat(document.getElementById('longitude').value) || -9.1393;
            var map = L.map('vendor-map').setView([lat, lng], 13);
