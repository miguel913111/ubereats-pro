                ...
                <div class="card card-body">
                        ...
                        <div class="">
                            <div class="__input-tab {{  $landing_integration_type == 'url'?'active':''  }}" id="url">
                                <div class="form-group mb-20">
                                    ...
                                    <input type="text"
                                        placeholder="{{ translate('messages.Ex: https://Nexo Food-web.6amtech.com/') }}"
                    ...
                    <div class="__bg-F8F9FC-card d-flex flex-wrap gap-3 align-items-center justify-content-between">
                         <div class="">
                            ...
                            <p class="fs-12 mb-0">
                                <span class="font-semibold">{{ (\App\CentralLogics\Helpers::get_business_data('business_name') ?? "Nexo Food" ) .' '. translate('Default') }} </span>
