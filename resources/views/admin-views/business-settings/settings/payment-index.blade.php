                ...
                <div class="collapse mt-3 show" id="payment_options_guide">
                    <div class="card card-body">
                        <div class="">
                            ...
                            <p class="fs-12 mb-0">
                                {{ translate('Nexo Food supports multiple payment methods to provide flexibility and convenience for customers while ensuring smooth transaction management for the platform and vendors.') }}
                            </p>
                            <ul class="fs-12">
